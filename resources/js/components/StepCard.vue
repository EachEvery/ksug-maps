<template>
  <div
    class="bg-black text-white p-4 w-60vw mt-55vh min-h-20rem max-w-sm || lg:mt-0 lg:w-full lg:mt-12"
    :data-step-geo="JSON.stringify(latLong)"
  >
    <img src="/images/upArrow.png" class="w-12 h-12" :style="getArrowStyle(step.maneuver.modifier)" />
