<template>
  <router-link class="relative shrink-when-active mb-8 flex flex-col" :to="`/tours/${tour.slug}`">
    <div class="p-4 bg-black text-white" style="height: 45%">
      <h3 class="uppercase font-display text-xl font-bold leading-none">{{ tour.name }}</h3>
