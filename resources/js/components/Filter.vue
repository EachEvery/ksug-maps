<template>
  <div class="leading-tight text-left px-5 h-full flex flex-col relative">
    ...
    <div class="flex mb-4" v-for="(filter, i) in filters" :key="i">
      ...
      <selectbox :options="roles" v-model="filter.role" class="flex-grow ml-4">Role</selectbox>

      <div class="ml-4 w-8 flex items-center">
        <clickable
        ...
        >
          <plus-icon class="w-4 h-4" style="transform: rotate(45deg); color: rgba(0,0,0,.6)" />
        </clickable>
